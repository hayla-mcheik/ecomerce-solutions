    ...
    <div class="feature-product-section mb-110">
         <div class="container">
            <div class="section-title3">
                <h3>Selling <span>Product</span> </h3>
                <div class="view-all">
            ...
            <div class="row g-4 ">
                   <div v-for="product in topsellingproducts" :key="product.id" class="col-lg-3 col-md-4 col-sm-6">
                                <div class="product-card style-3 hover-btn">
                                    ...
                                    <div class="product-card-content">
                                        <h6 class="font-extrabold"> <Link :href="'/product-details/' + product.id" class="hover-underline font-extrabold">{{ product.name }} </Link></h6>
                                     <p class="text-xs">{{ product.smalldesc }}</p> 
