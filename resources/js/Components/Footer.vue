                ...
                <div class="row g-lg-4 gy-5 justify-content-center">
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-widget">
                            <h3>Want <span>to Take <br></span> NanoEssecence Product <span>off our Shop</span>?</h3>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
                        <div class="footer-widget">
                            ...
                            <ul class="widget-list">
                                ...
                                <li><Link href="/products">Online Stores</Link></li>
                ...
                <div class="row">
                    <div class="col-lg-12 d-flex flex-md-row flex-column align-items-center justify-content-md-between justify-content-center flex-wrap gap-3">
                        <div class="footer-left">
                            <p>©Copyright 2025 NanoEssence | Design By <a href="https://www.webgenix.info/">WebGenix</a></p>
                        </div>
                        <div class="footer-logo">
                            <Link href="/"><img src="assets/img/nanologo.png" alt="" class="w-[150px]"></Link>
                        </div>
